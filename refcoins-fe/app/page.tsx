...
export default function Home() {
  return (
    ...
    <main>
      <div className="relative flex items-center justify-center h-[400px] bg-cover bg-center" style={{ backgroundImage: "url('https://img.daisyui.com/images/stock/photo-1625726411847-8cbb60cc71e6.jpg')" }}>
        ...
        <div className="relative p-4 rounded-lg z-10">
          ...
          <div className="flex flex-row bg-white p-3 rounded-md ">
            ...
            <button className="btn bg-blue-400 text-white px-10">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path d="M10 4a6 6 0 1 0 0 12 6 6 0 0 0 0-12zm-8 6a8 8 0 1 1 14.32 4.906l5.387 5.387a1 1 0 0 1-1.414 1.414l-5.387-5.387A8 8 0 0 1 2 10z" fill="#0D0D0D"/></svg>
              Search
            </button>
          </div>
        </div>
